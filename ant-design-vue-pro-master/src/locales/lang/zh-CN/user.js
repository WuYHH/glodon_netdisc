export default {
  ...
  'user.login.username.placeholder': '请输入邮箱',
  ...
  'user.register.email.placeholder': '请输入邮箱',
  'user.register.password.placeholder': '请至少输入 6 个字符,包含字母数字特殊字符至少三种以上',
  'user.register.password.popover-message': '请至少输入 6 个字符,包含字母数字特殊字符至少三种以上',
