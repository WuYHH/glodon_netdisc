  ...
  <div class="main">
    ...
    >
      ...
      <a-form-item>
        ...
        <div style="display: inline-block; margin-left: 5px;" @click="updateImg">
...
export default {
  ...
  created () {
    getCaptcha().then(res => {
      if (res.code === 200) {
        this.base64Image = 'data:image/jpg;base64,' + res.data.img
    ...
    handleSubmit (e) {
      ...
      validateFields(validateFieldsKey, { force: true }, (err, values) => {
        if (!err) {
          ...
          loginParams['inputCode'] = this.yzm
